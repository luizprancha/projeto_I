...
public class LojasDAO {
    ...
    public String buscarEnderecoPorCNPJ(String cnpj) {

    	String sql = "SELECT endereco FROM Lojas WHERE CNPJ = ?";
    	...
    	try {
    		...
    		if (rset.next()) {
    			return rset.getString("endereco");
    		}
    ...
    public String buscarNomePorCNPJ(String cnpj) {
    	String sql = "SELECT nome FROM Lojas WHERE CNPJ = ?";
    	Connection conexao = null;
    	PreparedStatement pstm = null;
    	ResultSet rset = null;
