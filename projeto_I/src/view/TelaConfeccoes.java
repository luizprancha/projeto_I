...
public class TelaConfeccoes extends JPanel {
	...
	public TelaConfeccoes() throws FontFormatException, IOException {
		...
		JLabel lbConfeccao = new JLabel("Nome da confecção");
		...
		JLabel lblNewLabel_2 = new JLabel("Nome da confecção");
		...
		JLabel lblNewLabel_4 = new JLabel("Nome da confecção");
		...
		JLabel lblNewLabel_6 = new JLabel("Nome da confecção");
		...
		JLabel lblNewLabel_7 = new JLabel("Nome da confecção");
		...
		JLabel lblNewLabel_10 = new JLabel("Nome da confecção");
		...
		JLabel lblNewLabel_12 = new JLabel("Nome da confecção");
		...
		JLabel lblNewLabel_14 = new JLabel("Nome da confecção");
		...
		JLabel lblNewLabel_16 = new JLabel("Nome da confecção");
