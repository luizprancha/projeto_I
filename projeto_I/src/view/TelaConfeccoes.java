...
public class TelaConfeccoes extends JPanel {
	...
	public TelaConfeccoes() throws FontFormatException, IOException {
		...
		JButton btnCadastrarConfeccao = new JButton("Cadastrar Confecção");
		btnCadastrarConfeccao.setBackground(new Color(235, 219, 194));
		btnCadastrarConfeccao.setOpaque(true);
		btnCadastrarConfeccao.setBorderPainted(false);
		btnCadastrarConfeccao.setFont(new Font("Tahoma", Font.PLAIN, 12));
