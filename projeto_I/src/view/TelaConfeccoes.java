...
public class TelaConfeccoes extends JPanel {
	...
	public TelaConfeccoes() throws FontFormatException, IOException {
		...
		JButton btnCadastrar = new JButton("Cadastrar Confecção");
		...
		JLabel lbConfeccao1 = new JLabel("Nome da confecção");
		panel_2.add(lbConfeccao1, "cell 1 0,alignx center");
		...
		JLabel lbConfeccao2 = new JLabel("Nome da confecção");
		panel_7.add(lbConfeccao2, "cell 1 0");
		...
		JLabel lbConfeccao3 = new JLabel("Nome da confecção");
		panel_6.add(lbConfeccao3, "cell 1 0");
		...
		JLabel lbConfeccao4 = new JLabel("Nome da confecção");
		panel_4.add(lbConfeccao4, "cell 1 0");
		...
		JLabel lbConfeccao5 = new JLabel("Nome da confecção");
		panel_5.add(lbConfeccao5, "cell 1 0");
		...
		JLabel lbConfeccao6 = new JLabel("Nome da confecção");
		panel_8.add(lbConfeccao6, "cell 1 0");
		...
		JLabel lbConfeccao7 = new JLabel("Nome da confecção");
		panel_3.add(lbConfeccao7, "cell 1 0");
		...
		JLabel lbConfeccao8 = new JLabel("Nome da confecção");
		panel_9.add(lbConfeccao8, "cell 1 0");
		...
		JLabel lbConfeccao9 = new JLabel("Nome da confecção");
		panel_10.add(lbConfeccao9, "cell 1 0");
